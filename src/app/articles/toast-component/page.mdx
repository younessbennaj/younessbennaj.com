...
import toastsImage from './toasts.png'

export const article = {
  author: 'Youness Bennaj',
  date: '2024-10-15',
  title: 'Creating a Custom Toast Notification Component',
  description:
    'This custom toast component provides a flexible way to show notifications in your web app. It supports multiple notification types and smooth animations, making it perfect for alerting users to important information without disrupting their workflow.',
}
...
<Image src={toastsImage} alt="" />

[View Repository](https://github.com/younessbennaj/toast-notifications) | [View Demo](https://toast-notifications-ecru.vercel.app/)
